package com.example.homepc.wallpaperhub.fragments;
...
public class SettingsFragments extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (FirebaseAuth.getInstance().getCurrentUser() == null) {
            return inflater.inflate(R.layout.fragments_settings_default, container, false);
        }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
            ...
            Glide.with(getActivity())
                    .load(Objects.requireNonNull(Objects.requireNonNull(user).getPhotoUrl()).toString())
                    .into(imageView);
                    ...
                    mGoogleSignInClient.signOut().addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            getActivity().getSupportFragmentManager().beginTransaction()
                                    .replace(R.id.content_area, new SettingsFragments())
                                    .commit();
                        }
                    });
                }
                ...
                new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(getActivity(), "Login Failure : " + Objects.requireNonNull(task.getException()).toString(), Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }

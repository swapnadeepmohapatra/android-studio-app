package com.example.homepc.wallpaperhub.Adapters;
...
import com.example.homepc.wallpaperhub.models.Wallpaper;
...
public class WallpapersAdapter extends RecyclerView.Adapter<WallpapersAdapter.WallpaperViewHolder> {
    ...
    class WallpaperViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
        ...
        private void setAsWallpaper(final Wallpaper wallpaper) {
            ...
            builder.setTitle("Do you want to set this as Wallpaper ?");
            builder.setItems(options, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Glide.with(mCtx)
                                ...
                                .into(new SimpleTarget<Bitmap>() {
                                    ...
                                    public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                                        WallpaperManager myWallpaperManager = WallpaperManager.getInstance(mCtx);
                                        try {
                    ...
                    if (i == 1) {
                        Toast.makeText(mCtx, "Canceled", Toast.LENGTH_SHORT).show();
                    }
                }
            });
            builder.show();
        ...
        private Uri saveWallpaperAndGetUri(Bitmap bitmap, String id) {
            ...
            File folder = new File(Environment.getExternalStorageDirectory().toString() + "/Wallpaper Hub");
            folder.mkdirs();
